...
import math
#计算pvalue
#print('多重假设检验-未设FWER阈值Initialize_HT  数据集：WebKB_Washington 测试集比例：80%   实验20次')
...
print("数据集Washington 测试集比例:0.2 本文提出的假设检验初始化方法 20次分类准确率的平均值:")
print(accu/20)